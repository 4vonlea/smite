...
class Transaction extends Admin_Controller
{
	...
	public function add_cart()
	{
		...
		$this->Transaction_m->setDiscount($idTransaction, $memberId);
	...
	public function delete_item()
	{
		...
		$modelToDelete = $this->Transaction_detail_m->findOne($id);
		...
		$this->Transaction_m->setDiscount($this->input->post("transaction_id"), $modelToDelete->member_id);
		$this->output->set_content_type("application/json")
