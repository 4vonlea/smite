                                ...
                                <div class="card card-achievement" v-if="showCategory == event.category">
                                    ...
                                    <div :id="'accordion-'+index" class="card-body collapse show table-responsive">
                                            <div class="alert alert-success text-center" style="margin-bottom:0px" v-if="event.followed">
                                                ...
                                                <a class="btn btn-primary" :href="'<?=base_url('member/area/card');?>/'+event.id+'/'+user.id" target="_blank">Download Name Tag</a>
                                                        ...
                                                        <tr v-for="member in event.memberStatus">
                                                            ...
                                                            <td v-for="pricing in event.pricingName" class="text-center">
                                                                <span v-if="pricing.pricing[member]">
                                                                    ...
                                                                    <button @click="addToCart(pricing.pricing[member],member,event.name,event.id)" v-if="pricing.pricing[member].available && !pricing.pricing[member].added && !pricing.pricing[member].waiting_payment" :disabled="adding"  class="btn btn-sm btn-primary"><i v-if="adding" class="fa fa-spin fa-spinner"></i> Add To Cart</button>
