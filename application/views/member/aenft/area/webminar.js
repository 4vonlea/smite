                                        ...
                                        <template v-for="(link,indSpl) in d.items">
                                            <tr :class="{'bg-danger':link.showingClass == 'badge badge-danger'}">
                                                ...
                                                <td :rowspan="2" class="" style="white-space: nowrap;">
                                                    <button :disabled="(link.finishWatch == '0' && link.advertisement) || link.url == '#' || link.timeReady " v-on:click="join(link.url)" class="btn btn-success btn-block">
                                                    <i class="fa fa-video"></i>{{ link.showingClass == 'badge badge-success' ? 'Live Now' : 'Join Now' }}
                                                    </button>
                                                    <button v-show="link.urlRecording" @click="showRecording(link)" class="btn btn-success btn-block">
                                                     <i class="fa fa-play"></i>View Recordings
                                                    </button>
