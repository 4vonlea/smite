			...
			<div v-if="!loading && !fail">
				...
				<div v-if="mode == 0" class="table-responsive">
					<table class="table text-light border">
						<thead>
							<tr>
								<th class="border-end text-white" width="15%">Manuscript Section</th>
								<th class="border-end text-white" width="15%">Manuscript Category</th>
								<th class="border-end text-white">Title</th>
								<th class="border-end text-white">Status</th>
								<th class="border-end" width="10%">
									<button :disabled="isAfter(paper.deadline.paper_cutoff)"
										...
										class="btn btn-primary add-record"><i class="fa fa-circle-plus"></i> Add</button>
								</th>
							</tr>
						</thead>
						<tbody>
