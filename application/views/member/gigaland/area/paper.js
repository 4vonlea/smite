        ...
        <div class="col-lg-12">
						...
						<div class="modal-body">
							<form ref="formFullpaper" enctype="multipart/form-data">
								...
								<div class="form-group">
									<label class="font-weight-bold form-control-label text-2">Paper Title</label>
									<label>{{ formFullpaper.title}}</label>
								</div>
								<div class="form-group">
									<label class="font-weight-bold form-control-label text-2">Presentation on{{ formFullpaper.type_presence}}</label>
								</div>
								<hr/>
            ...
            <div v-if="!loading && !fail">
                <div class="overflow-hidden mb-1">
                    <h2 class="font-weight-normal color-heading text-7 mb-0"><strong class="font-weight-extra-bold">Send Paper</strong></h2>
                </div>
				...
				<p class="mb-0">*<small class="font-weight-bold">You can change/reupload your fullpaper or presentation/poster file, on detail page (magnifying glass icon)</small></p>
				<p class="mb-0">*<small class="font-weight-bold">Note: the abstract that has been submitted cannot be deleted, please make sure to fill in correctly</small></p>

                <div v-if="mode == 0" class="table-responsive">
                	<table class="table text-light border">
                		<thead>
                			<tr>
                				<th class="border-end" width="15%">Type</th>
                				<th class="border-end" width="40%">Title</th>
                				<th class="border-end" width="30%">Status</th>
                				<th class="border-end" width="15%"h>
									<button :disabled="isAfter(paper.deadline.paper_cutoff)" @click="mode = 1; form = {co_author:[],type:'Case Report',type_presence:'',methods:'',check:null};detail=false;error_upload ={};" class="btn btn-primary"><i class="fa fa-plus"></i> Add</button>
								</th>
							</tr>
						</thead>
						<tbody>
                ...
                <div v-if="mode == 1">
                    <form ref="form" enctype="multipart/form-data" class="form-border">
						...
						<div v-if="detail && form.status_fullpaper == 0 && form.feedback_fullpaper" class="form-group row mb-2">
							<label class="col-lg-3 font-weight-bold col-form-label form-control-label text-2">Fullpaper Feedback</label>
							<div class="col-lg-9">
						...
						<div v-if="detail && form.status_presentasi == 0 && form.feedback_file_presentasi" class="form-group row mb-2">
							<label class="col-lg-3 font-weight-bold col-form-label form-control-label text-2">File Presentation Feedback</label>
							<div class="col-lg-9">
						...
						<div v-if="detail && form.status_presentasi == 0 && form.feedback_fullpaper" class="form-group row mb-2">
							<label class="col-lg-3 font-weight-bold col-form-label form-control-label text-2">Presentation Feedback</label>
							<div class="col-lg-9">
								<span>{{ form.feedback_presentasi }}</span>
							</div>
						</div>
						<div v-if="detail &&  form.status_fullpaper == 2" class="form-group row mb-2">
							<label class="col-lg-3 font-weight-bold col-form-label form-control-label text-2">Presentation Link</label>
							<div class="col-lg-9">
								<span v-if="form.poster"><a  :href="paperUrl(form.poster)">Click Here</a> | </span>
								<a v-if="form.status_presentasi != 2" href="#" @click.prevent="modalFullpaper(form)">Change/Upload Presentation File</a>
							</div>
						</div>

                    	<div class="form-group row mb-2">
                    		<label class="col-lg-3 font-weight-bold col-form-label form-control-label text-2">Abstract Type*</label>
							<div class="col-lg-9">
						...
						<div class="form-group row mb-2">
                    		<label class="col-lg-3 font-weight-bold col-form-label form-control-label text-2">Study Type*</label>
							<div class="col-lg-9">
								...
								<input :disabled="form.methods != 'Other' || detail" placeholder="If the type of study is other than the list above, please describe it here"  :class="[{'is-invalid':error_upload.methods}, form.methods != 'Other' ? 'd-none':'']" class="form-control mt-1" name="type_study_other"  type="text" v-model="form.type_study_other" value="">
								<div v-if="error_upload.methods" class="invalid-feedback">{{ error_upload.methods }}</div>
							</div>
						</div>
						<div class="form-group row mb-2">
							<label class="col-lg-3 font-weight-bold col-form-label form-control-label text-2">Title*</label>
							<div class="col-lg-9">
						...
						<!--
						<div class="form-group row mb-2">
                    		<label class="col-lg-3 font-weight-bold col-form-label form-control-label text-2">Presentation On*</label>
							<div class="col-lg-9">
						...
						-->
<!--						<div class="form-group row mb-2">-->
<!--							<label class="col-lg-3 font-weight-bold col-form-label form-control-label text-2">Purpose*</label>-->
<!--							<div class="col-lg-9">-->
...
<!--						</div>-->
						...
						<div v-if="detail && form.status == 0 && form.feedback" class="form-group row mb-2">
							<label class="col-lg-3 font-weight-bold col-form-label form-control-label text-2">File Abstract Feedback</label>
							<div class="col-lg-9">
								<a :href="feedbackUrl(form.feedback)">Click Here</a>
							</div>
						</div>
						<div v-if="detail && form.message" class="form-group row mb-2">
							<label class="col-lg-3 font-weight-bold col-form-label form-control-label text-2">Abstract Feedback</label>
							<div class="col-lg-9">
								<span>{{ form.message }}</span>
							</div>
						</div>
						<div class="form-group row mb-2">
							<label class="col-lg-3 font-weight-bold col-form-label form-control-label text-2">Co-Author <small>(if exits)</small></label>
