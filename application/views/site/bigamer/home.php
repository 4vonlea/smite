		...
		<div class="container">
			<div class="">
				<div class="banner-content text-center">
					...
					<a href="https://drive.google.com/file/d/1UoneqLS7i6vwORdP7k4WuvQXQM5n0bPe/view" class="default-button reverse-effect"><span>Unduh FINAL Announcement disini (rilis 05 November 2022)<i class="icofont-play-alt-1"></i></span> </a>
				</div>
				...
				<div class="row g-5 justify-content-center row-cols-md-6 row-cols-sm-6 row-cols-2 mt-1">
					...
					<div class="col">
						<div class="sponsor-item">
							<div class="sponsor-inner">
								<div class="sponsor-thumb text-center">
									<img src="<?= base_url('themes/bigamer'); ?>/assets/images/sponsor/bronze/7_alomedika.png" alt="sponsor-thumb">
								</div>
							</div>
						</div>
					</div>
