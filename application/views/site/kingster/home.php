		...
		<ul>
			<li data-transition="fade">
				...
				<div class="tp-caption custom-secondary-font font-weight-bold text-color-light"
					 ...
					 data-start="800"
					 data-transform_in="y:[-300%];opacity:0;s:500;" style="font-size: 30px;">East Indonesian Society of
								...
								<div class="card-header">
									<h4 class="card-title m-0">
										<a class="accordion-toggle collapsed" data-toggle="collapse"
										   data-parent="#accordion7" href="#colap<?php echo $colap; ?>"
										   aria-expanded="false">
											<?php echo $row2->kondisi ?> <span class="custom-accordion-plus"></span>
										</a>
									</h4>
								</div>
								<div id="colap<?php echo $colap; ?>" class="collapse" aria-expanded="false"
									 style="height: 0px;">
									<div class="card-body">
										<p>
											<?php
		...
		<div class="row align-items-center">
			...
			<div class="col-md-3 col-lg-4">
				<div class="looking-for-box">
					...
					<a class="text-decoration-none"
					   href="<?= base_url('themes/porto'); ?>/pengumuman/second_Announcement.pdf" target="_blank">
                        <span class="custom-call-to-action white-border text-color-light">
                            <span class="action-info"><input type="submit" value=Download
															 class="btn  custom-border-width btn-primary custom-border-radius font-weight-semibold text-uppercase"
															 style="border:solid #fff 2px"></span>
                        </span>
					</a>
			...
			<div class="col-md-3 col-lg-5">
				<div class="looking-for-box">
					...
					<a class="text-decoration-none" href="<?= base_url('themes/porto'); ?>/pengumuman/pedoman.rtf"
					   target="_blank">
                        <span class="custom-call-to-action white-border text-color-light">
                            <span class="action-info"><input type="submit" value=Download
															 class="btn  custom-border-width btn-primary custom-border-radius font-weight-semibold text-uppercase"
	...
	<div class="container pb-2">
		<div class="row">
			<div class="col-lg-7 text-center text-md-left mb-5 mb-lg-0">
				<h2 class="text-color-dark font-weight-normal text-6 mb-2"><strong class="font-weight-extra-bold">How to
						register :</strong></h2>
			...
			<div class="col-lg-5 text-center text-md-left mb-5 mb-lg-0">
				<h2 class="text-color-dark font-weight-normal text-6 mb-2"><strong class="font-weight-extra-bold">Ketentuan
						paket promo :</strong></h2>
				<ol class="text-color-dark text-4 line-height-5 mb-0">
					<li>Promo bersifat terbatas dan dapat habis sewaktu-waktu. Siapa cepat dia dapat</li>
					<li>Untuk dapat menggunakan diskon promo, silakan piliih item-item workshop yang punya diskon promo
						lalu pilih item diskon nya di menu event setelah login.
					</li>
			...
			<article class="blog-post col">
				<div class="row">
					<div class="col-sm-8 col-lg-4">
						<div class="owl-carousel owl-theme nav-inside float-left mr-4 mb-2"
							 data-plugin-options="{'items': 1, 'margin': 10, 'animateOut': 'fadeOut','autoplay': true}">
							<div>
