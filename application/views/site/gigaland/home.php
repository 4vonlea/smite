                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-12 wow fadeInRight" data-wow-delay=".5s">
                                <div class="d-desc text-center">
                                    ...
                                    <a href="<?= base_url('themes/gigaland'); ?>/images/220601 AOMC 2022 Accepted Abstract List.pdf" target="blank" class="btn-main btn-lg" style="background-color:#F4AD39; color:black;">Download "AOMC Category: Accepted Abstract List" (Updated on 1 June)</a>&nbsp;
...
<br>
            ...
            <div class="container">
                ...
                <div class="row wow fadeInRight" data-wow-delay=".5s">
                    ...
                    <div id="collection-carousel-alt" class="owl-carousel wow fadeInRight" data-wow-delay=".5s">
                        ...
                        <div class="nft_coll">
                            <div class="nft_wrap">
                                <a href="03_grey-collection.html"><img src="<?= base_url('themes/gigaland'); ?>/images/speaker/epilepsi/1.png" class="lazy img-fluid" alt=""></a>
                            </div>
                            <div class="nft_coll_info">
                                <br>
                                <a href="">
                                    <h4 style="color:#F4AD39; font-size: 18px;">Prof. Dr. Harsono. Sp.S(K)</h4>
                                </a>
                                <span>"Epilepsi"</span><br><br>
                            </div>
                        </div>

                        <div class="nft_coll">
                            <div class="nft_wrap">
                                <a href="03_grey-collection.html"><img src="<?= base_url('themes/gigaland'); ?>/images/speaker/epilepsi/2.png" class="lazy img-fluid" alt=""></a>
                            </div>
                            <div class="nft_coll_info">
                                <br>
                                <a href="">
                                    <h4 style="color:#F4AD39; font-size: 18px;">Dr.dr. Kurnia Kusumastuti, Sp.S(K)</h4>
                                </a>
                                <span>"Epilepsi"</span>
                            </div>
                        </div>
                        ...
                        <div class="nft_coll">
                            <div class="nft_wrap">
                                <a href="03_grey-collection.html"><img src="<?= base_url('themes/gigaland'); ?>/images/speaker/epilepsi/3.png" class="lazy img-fluid" alt=""></a>
                            </div>
                            <div class="nft_coll_info">
                                <br>
                                <a href="">
                                    <h4 style="color:#F4AD39; font-size: 18px;">Dr.dr. AA Ayu Meidiary, Sp.S (K)</h4>
                                </a>
                                <span>"Epilepsi"</span>
                            </div>
                        </div>
                        ...
                        <div class="nft_coll">
                            <div class="nft_wrap">
                                <a href="03_grey-collection.html"><img src="<?= base_url('themes/gigaland'); ?>/images/speaker/epilepsi/4.png" class="lazy img-fluid" alt=""></a>
                            </div>
                            <div class="nft_coll_info">
                                <br>
                                <a href="">
                                    <h4 style="color:#F4AD39; font-size: 18px;">dr. Wardah Rahmatul Islamiyah, Sp.S</h4>
                                </a>
                                <span>"Epilepsi"</span>
                            </div>
                        </div>
                        ...
                        <div class="nft_coll">
                            <div class="nft_wrap">
                                <a href="03_grey-collection.html"><img src="<?= base_url('themes/gigaland'); ?>/images/speaker/epilepsi/5.png" class="lazy img-fluid" alt=""></a>
                            </div>
                            <div class="nft_coll_info">
                                <br>
                                <a href="">
                                    <h4 style="color:#F4AD39; font-size: 18px;">dr. Sri Handayani, Sp.S(K)</h4>
                                </a>
                                <span>"Epilepsi"</span>
                            </div>
                        </div>
                        ...
                        <div class="nft_coll">
                            <div class="nft_wrap">
                                <a href="03_grey-collection.html"><img src="<?= base_url('themes/gigaland'); ?>/images/speaker/epilepsi/6.png" class="lazy img-fluid" alt=""></a>
                            </div>
                            <div class="nft_coll_info">
                                <br>
                                <a href="">
                                    <h4 style="color:#F4AD39; font-size: 18px;">dr. Ria Damayanti, Sp. N (K)</h4>
                                </a>
                                <span>"Epilepsi"</span>
                            </div>
                        </div>
                        ...
                        <div class="nft_coll">
                            <div class="nft_wrap">
                                <a href="03_grey-collection.html"><img src="<?= base_url('themes/gigaland'); ?>/images/speaker/epilepsi/7.png" class="lazy img-fluid" alt=""></a>
                            </div>
                            <div class="nft_coll_info">
                                <br>
                                <a href="">
                                    <h4 style="color:#F4AD39; font-size: 18px;">dr. Meiti Frida, Sp.S (K)</h4>
                                </a>
                                <span>"Epilepsi"</span><br><br>
                            </div>
                        </div>
                        ...
                        <div class="nft_coll">
                            <div class="nft_wrap">
                                <a href="03_grey-collection.html"><img src="<?= base_url('themes/gigaland'); ?>/images/speaker/epilepsi/8.png" class="lazy img-fluid" alt=""></a>
                            </div>
                            <div class="nft_coll_info">
                                <br>
                                <a href="">
                                    <h4 style="color:#F4AD39; font-size: 18px;">dr. Machlusil Husna, Sp.S (K)</h4>
                                </a>
                                <span>"Epilepsi"</span>
                            </div>
                        </div>
                        ...
                        <div class="nft_coll">
                            <div class="nft_wrap">
                                <a href="03_grey-collection.html"><img src="<?= base_url('themes/gigaland'); ?>/images/speaker/epilepsi/9.png" class="lazy img-fluid" alt=""></a>
                            </div>
                            <div class="nft_coll_info">
                                <br>
                                <a href="">
                                    <h4 style="color:#F4AD39; font-size: 18px;">dr. Hendra Permana, Sp.S(K)</h4>
                                </a>
                                <span>"Epilepsi"</span>
                            </div>
                        </div>
                        ...
                        <div class="nft_coll">
                            <div class="nft_wrap">
                                <a href="03_grey-collection.html"><img src="<?= base_url('themes/gigaland'); ?>/images/speaker/epilepsi/10.png" class="lazy img-fluid" alt=""></a>
                            </div>
                            <div class="nft_coll_info">
                                <br>
                                <a href="">
                                    <h4 style="color:#F4AD39; font-size: 16px;">Dr. dr. Suryani Gunadharma, Sp.S (K), M.Kes</h4>
                                </a>
                                <span>"Epilepsi"</span>
                            </div>
                        </div>
                        ...
                        <div class="nft_coll">
                            <div class="nft_wrap">
                                <a href="03_grey-collection.html"><img src="<?= base_url('themes/gigaland'); ?>/images/speaker/epilepsi/11.png" class="lazy img-fluid" alt=""></a>
                            </div>
                            <div class="nft_coll_info">
                                <br>
                                <a href="">
                                    <h4 style="color:#F4AD39; font-size: 18px;">Dr. dr. Herlyani Khosama, Sp.S (K)</h4>
                                </a>
                                <span>"Epilepsi"</span>
                            </div>
                        </div>
                        ...
                        <div class="nft_coll">
                            <div class="nft_wrap">
                                <a href="03_grey-collection.html"><img src="<?= base_url('themes/gigaland'); ?>/images/speaker/epilepsi/12.png" class="lazy img-fluid" alt=""></a>
                            </div>
                            <div class="nft_coll_info">
                                <br>
                                <a href="">
                                    <h4 style="color:#F4AD39; font-size: 18px;">Dr. dr. Fitri Octaviana, Sp.S (K)</h4>
                                </a>
                                <span>"Epilepsi"</span>
                            </div>
                        </div>
                        ...
                        <div class="nft_coll">
                            <div class="nft_wrap">
                                <a href="03_grey-collection.html"><img src="<?= base_url('themes/gigaland'); ?>/images/speaker/epilepsi/13.png" class="lazy img-fluid" alt=""></a>
                            </div>
                            <div class="nft_coll_info">
                                <br>
                                <a href="">
                                    <h4 style="color:#F4AD39; font-size: 18px;">Dr. dr. Astri Budikayanti, Sp.S (K)</h4>
                                </a>
                                <span>"Epilepsi"</span>
                            </div>
                        </div>
                        ...
                        <div class="nft_coll">
                            <div class="nft_wrap">
                                <a href="03_grey-collection.html"><img src="<?= base_url('themes/gigaland'); ?>/images/speaker/epilepsi/14.png" class="lazy img-fluid" alt=""></a>
                            </div>
                            <div class="nft_coll_info">
                                <br>
                                <a href="">
                                    <h4 style="color:#F4AD39; font-size: 18px;">dr. Donny Hamdani Hamid SpS(K)</h4>
                                </a>
                                <span>"Epilepsi"</span>
                            </div>
                        </div>
                        ...
                        <div class="nft_coll">
                            <div class="nft_wrap">
                                <a href="03_grey-collection.html"><img src="<?= base_url('themes/gigaland'); ?>/images/speaker/epilepsi/15.png" class="lazy img-fluid" alt=""></a>
                            </div>
                            <div class="nft_coll_info">
                                <br>
                                <a href="">
                                    <h4 style="color:#F4AD39; font-size: 18px;">dr. Dede Gunawan, Sp.S (K)</h4>
                                </a>
                                <span>"Epilepsi"</span>
                            </div>
                        </div>
                        <div class="nft_coll">
                            <div class="nft_wrap">
                                <a href="03_grey-collection.html"><img src="<?= base_url('themes/gigaland'); ?>/images/speaker/epilepsi/16.png" class="lazy img-fluid" alt=""></a>
                            </div>
                            <div class="nft_coll_info">
                                <br>
                                <a href="">
                                    <h4 style="color:#F4AD39; font-size: 18px;">Dr. dr. Anna Marita Gelgel, SpS(K)</h4>
                                </a>
                                <span>"Epilepsi"</span>
                            </div>
                        </div>
                        ...
                        <div class="nft_coll">
                            <div class="nft_wrap">
                                <a href="03_grey-collection.html"><img src="<?= base_url('themes/gigaland'); ?>/images/speaker/hukumetik/1.png" class="lazy img-fluid" alt=""></a>
                            </div>
                            <div class="nft_coll_info">
                                <br>
                                <a href="">
                                    <h4 style="color:#F4AD39; font-size: 16px;">Dr. dr. Iskandar Nasution, MKM, SpS (K), FINS</h4>
                                </a>
                                <span>"Hukum Etik"</span>
                            </div>
                        </div>
                        <div class="nft_coll">
                            <div class="nft_wrap">
                                <a href="03_grey-collection.html"><img src="<?= base_url('themes/gigaland'); ?>/images/speaker/hukumetik/2.png" class="lazy img-fluid" alt=""></a>
                            </div>
                            <div class="nft_coll_info">
                                <br>
                                <a href="">
                                    <h4 style="color:#F4AD39; font-size: 18px;">dr. Johan Akbari, Sp. S, SH, MARS</h4>
                                </a>
                                <span>"Hukum Etik"</span>
                            </div>
                        </div>
                        <div class="nft_coll">
                            <div class="nft_wrap">
                                <a href="03_grey-collection.html"><img src="<?= base_url('themes/gigaland'); ?>/images/speaker/hukumetik/3.png" class="lazy img-fluid" alt=""></a>
                            </div>
                            <div class="nft_coll_info">
                                <br>
                                <a href="">
                                    <h4 style="color:#F4AD39; font-size: 18px;">dr.Pukovisa Prawiroharjo, Sp.N(K)</h4>
                                </a>
                                <span>"Hukum Etik"</span>
                            </div>
                        </div>
                        ...
                        <div class="nft_coll">
                            <div class="nft_wrap">
                                <a href="03_grey-collection.html"><img src="<?= base_url('themes/gigaland'); ?>/images/speaker/neurofisiologi/1.png" class="lazy img-fluid" alt=""></a>
                            </div>
                            <div class="nft_coll_info">
                                <br>
                                <a href="">
                                    <h4 style="color:#F4AD39; font-size: 18px;">Dr. Aldy Novriansyah, SpS</h4>
                                </a>
                                <span>"Neurofisiologi"</span>
                            </div>
                        </div>
                        <div class="nft_coll">
                            <div class="nft_wrap">
                                <a href="03_grey-collection.html"><img src="<?= base_url('themes/gigaland'); ?>/images/speaker/neurofisiologi/2.png" class="lazy img-fluid" alt=""></a>
                            </div>
                            <div class="nft_coll_info">
                                <br>
                                <a href="">
                                    <h4 style="color:#F4AD39; font-size: 18px;">Dr. dr. Aida Fithrie, Sp.S(K)</h4>
                                </a>
                                <span>"Neurofisiologi"</span>
                            </div>
                        </div>
                        <div class="nft_coll">
                            <div class="nft_wrap">
                                <a href="03_grey-collection.html"><img src="<?= base_url('themes/gigaland'); ?>/images/speaker/neurofisiologi/3.png" class="lazy img-fluid" alt=""></a>
                            </div>
                            <div class="nft_coll_info">
                                <br>
                                <a href="">
                                    <h4 style="color:#F4AD39; font-size: 18px;">dr. Corry Novita Mahama, Sp.S(K)</h4>
                                </a>
                                <span>"Neurofisiologi"</span>
                            </div>
                        </div>
                        <div class="nft_coll">
                            <div class="nft_wrap">
                                <a href="03_grey-collection.html"><img src="<?= base_url('themes/gigaland'); ?>/images/speaker/neurofisiologi/4.png" class="lazy img-fluid" alt=""></a>
                            </div>
                            <div class="nft_coll_info">
                                <br>
                                <a href="">
                        ...
                        <div class="nft_coll">
                            <div class="nft_wrap">
                                <a href="03_grey-collection.html"><img src="<?= base_url('themes/gigaland'); ?>/images/speaker/neurofisiologi/5.png" class="lazy img-fluid" alt=""></a>
                            </div>
                            <div class="nft_coll_info">
                                <br>
                                <a href="">
                        ...
                        <div class="nft_coll">
                            <div class="nft_wrap">
                                <a href="03_grey-collection.html"><img src="<?= base_url('themes/gigaland'); ?>/images/speaker/neurofisiologi/6.png" class="lazy img-fluid" alt=""></a>
                            </div>
                            <div class="nft_coll_info">
                                <br>
                                <a href="">
                                    <h4 style="color:#F4AD39; font-size: 18px;">Dr. Nani Kurniani, SpS(K)</h4>
                                </a>
                                <span>"Neurofisiologi"</span><br><br>
                            </div>
                        </div>
                        <div class="nft_coll">
                            <div class="nft_wrap">
                                <a href="03_grey-collection.html"><img src="<?= base_url('themes/gigaland'); ?>/images/speaker/neurofisiologi/7.png" class="lazy img-fluid" alt=""></a>
                            </div>
                            <div class="nft_coll_info">
                                <br>
                                <a href="">
                                    <h4 style="color:#F4AD39; font-size: 18px;">Dr.dr. Shahdevi Nandar Kurniawan, SpS(K)</h4>
                                </a>
                                <span>"Neurofisiologi"</span>
                            </div>
                        </div>
                        ...
                        <div class="nft_coll">
                            <div class="nft_wrap">
                                <a href="03_grey-collection.html"><img src="<?= base_url('themes/gigaland'); ?>/images/speaker/neurootologi/1.png" class="lazy img-fluid" alt=""></a>
                            </div>
                            <div class="nft_coll_info">
                                <br>
                                <a href="">
                                    <h4 style="color:#F4AD39; font-size: 18px;">dr. Eva Dewati, Sp.S(K)</h4>
                                </a>
                                <span>"Neurootologi"</span><br><br>
                            </div>
                        </div>
                        <div class="nft_coll">
                            <div class="nft_wrap">
                                <a href="03_grey-collection.html"><img src="<?= base_url('themes/gigaland'); ?>/images/speaker/neurootologi/2.png" class="lazy img-fluid" alt=""></a>
                            </div>
                            <div class="nft_coll_info">
                                <br>
                                <a href="">
                                    <h4 style="color:#F4AD39; font-size: 18px;">dr. Maria Belladona, Sp.S (K)</h4>
                                </a>
                                <span>"Neurootologi"</span>
                            </div>
                        </div>
                        <div class="nft_coll">
                            <div class="nft_wrap">
                                <a href="03_grey-collection.html"><img src="<?= base_url('themes/gigaland'); ?>/images/speaker/neurootologi/3.png" class="lazy img-fluid" alt=""></a>
                            </div>
                            <div class="nft_coll_info">
                                <br>
                                <a href="">
                                    <h4 style="color:#F4AD39; font-size: 18px;">dr. Ni Nengah Rida Ariani, Sp.S (K)</h4>
                                </a>
                                <span>"Neurootologi"</span>
                            </div>
                        </div>
                        <div class="nft_coll">
                            <div class="nft_wrap">
                                <a href="03_grey-collection.html"><img src="<?= base_url('themes/gigaland'); ?>/images/speaker/neurootologi/4.png" class="lazy img-fluid" alt=""></a>
                            </div>
                            <div class="nft_coll_info">
                                <br>
                                <a href="">
                                    <h4 style="color:#F4AD39; font-size: 18px;">Prof. Dr. dr. Sri Sutarni, Sp. S(K)</h4>
                                </a>
                                <span>"Neurootologi"</span>
                            </div>
                        </div>
                        ...
                        <div class="nft_coll">
                            <div class="nft_wrap">
                                <a href="03_grey-collection.html"><img src="<?= base_url('themes/gigaland'); ?>/images/speaker/neuropediatri/1.png" class="lazy img-fluid" alt=""></a>
                            </div>
                            <div class="nft_coll_info">
                                <br>
                                <a href="">
                                    <h4 style="color:#F4AD39; font-size: 18px;">Dr. Cempaka Thursina, dr SpS(K)</h4>
                                </a>
                                <span>"Neuropediatri"</span>
                            </div>
                        </div>
                        <div class="nft_coll">
                            <div class="nft_wrap">
                                <a href="03_grey-collection.html"><img src="<?= base_url('themes/gigaland'); ?>/images/speaker/neuropediatri/2.png" class="lazy img-fluid" alt=""></a>
                            </div>
                            <div class="nft_coll_info">
                                <br>
                                <a href="">
                                    <h4 style="color:#F4AD39; font-size: 18px;">dr. Eko Arisetijono SpS(K)</h4>
                                </a>
                                <span>"Neuropediatri"</span>
                            </div>
                        </div>
                        <div class="nft_coll">
                            <div class="nft_wrap">
                                <a href="03_grey-collection.html"><img src="<?= base_url('themes/gigaland'); ?>/images/speaker/neuropediatri/3.png" class="lazy img-fluid" alt=""></a>
                            </div>
                            <div class="nft_coll_info">
                                <br>
                                <a href="">
                        ...
                        <div class="nft_coll">
                            <div class="nft_wrap">
                                <a href="03_grey-collection.html"><img src="<?= base_url('themes/gigaland'); ?>/images/speaker/neuropediatri/4.png" class="lazy img-fluid" alt=""></a>
                            </div>
                            <div class="nft_coll_info">
                                <br>
                                <a href="">
                                    <h4 style="color:#F4AD39; font-size: 18px;">Prof. Dr. Kiking Ritarwan dr. SpS(K)</h4>
                                </a>
                                <span>"Neuropediatri"</span>
                            </div>
                        </div>
                        <div class="nft_coll">
                            <div class="nft_wrap">
                                <a href="03_grey-collection.html"><img src="<?= base_url('themes/gigaland'); ?>/images/speaker/neuropediatri/5.png" class="lazy img-fluid" alt=""></a>
                            </div>
                            <div class="nft_coll_info">
                                <br>
                                <a href="">
                                    <h4 style="color:#F4AD39; font-size: 18px;">dr. Reggy Panggabean Sp.S(K)</h4>
                                </a>
                                <span>"Neuropediatri"</span>
                            </div>
                        </div>
                        <div class="nft_coll">
                            <div class="nft_wrap">
                                <a href="03_grey-collection.html"><img src="<?= base_url('themes/gigaland'); ?>/images/speaker/neuropediatri/6.png" class="lazy img-fluid" alt=""></a>
                            </div>
                            <div class="nft_coll_info">
                                <br>
                                <a href="">
                                    <h4 style="color:#F4AD39; font-size: 18px;">dr. Siti Aminah Sobana, SpS(K)</h4>
                                </a>
                                <span>"Neuropediatri"</span>
                            </div>
                        </div>
                        <div class="nft_coll">
                            <div class="nft_wrap">
                                <a href="03_grey-collection.html"><img src="<?= base_url('themes/gigaland'); ?>/images/speaker/neuropediatri/7.png" class="lazy img-fluid" alt=""></a>
                            </div>
                            <div class="nft_coll_info">
                                <br>
                                <a href="">
                                    <h4 style="color:#F4AD39; font-size: 18px;">Dr. Susi Aulina dr. Sp.S(K)</h4>
                                </a>
                                <span>"Neuropediatri"</span><br><br>
                            </div>
                        </div>
                        <div class="nft_coll">
                            <div class="nft_wrap">
                                <a href="03_grey-collection.html"><img src="<?= base_url('themes/gigaland'); ?>/images/speaker/neuropediatri/8.png" class="lazy img-fluid" alt=""></a>
                            </div>
                            <div class="nft_coll_info">
                                <br>
                                <a href="">
                                    <h4 style="color:#F4AD39; font-size: 18px;">Dr. Uni Gamayani dr. SpS(K)</h4>
                                </a>
                                <span>"Neuropediatri"</span>
                            </div>
                        </div>
    ...
    <section id="abstract" class="pt30 pb30">
        <div class="container">
                            ...
                            <div class="tab-pane" id="tab-3">
                                <figure>
                                    <div class="col-lg-12 col-md-6 footer-links text-left">
                                        ...
                                        <a href="<?= base_url('themes/gigaland'); ?>/images/220601 AOMC 2022_Scientific Program Update.pdf" target="blank" class="btn-main btn-sm" style="background-color:#00fdff; color:black;">AOMC 2022 Scientific Programme (updated on 1 June)</a>&nbsp;<br><br>
                                    </div>
                                </figure>
                            </div>
                ...
                <div class="row enampuluh">
                    <div class="col-lg-4 col-md-6 mb-sm-30 text-center">
                        <div class="feature-box f-boxed style-3" style="height: 500px;">
                            ...
                            <p class="wow fadeInUp" data-wow-delay=".25s" style="color:#F4AD39; font-size:12px;">(Registration)</p>
                    ...
                    <div class="col-lg-4 col-md-6 mb-sm-30 text-center">
                        <div class="feature-box f-boxed style-3" style="height: 500px;">
                            ...
                            <div class="text">
                                <h3 class="wow fadeInUp" data-wow-delay=".25s" style="color:#F4AD39;">Misnah, B.Psy</h3>
                            </div>
                            <p class="wow fadeInUp" data-wow-delay=".25s" style="color:#F4AD39; font-size:15px;">(Registration)</p>
                            <a target="blank" href="https://wa.me/6289632659482"><i class="fa fa-whatsapp" style="background-color:#F4AD39; color:black;"></i></a><br>
                            <p class="wow fadeInUp" data-wow-delay=".25s" style="color:#F4AD39; font-size:14px;">admin@aomc-pinbanjarmasin2022.com</p>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 mb-sm-30 text-center">
                        <div class="feature-box f-boxed style-3" style="height: 500px;">
                            <img src="<?= base_url('themes/gigaland'); ?>/images/helpdesk7.png" class="lazy img-fluid" alt="">
                            <div class="text">
                                <h3 class="wow fadeInUp" data-wow-delay=".25s" style="color:#F4AD39;">Helmi Faniasa, B.Ed</h3>
                            </div>
                            <p class="wow fadeInUp" data-wow-delay=".25s" style="color:#F4AD39; font-size:15px;">(Technical Support)</p>
                            <a target="blank" href="https://wa.me/6285387734047"><i class="fa fa-whatsapp" style="background-color:#F4AD39; color:black;"></i></a><br>
                            <p class="wow fadeInUp" data-wow-delay=".25s" style="color:#F4AD39; font-size:14px;">admin@aomc-pinbanjarmasin2022.com</p>
                        </div>
                    </div>
                </div>
