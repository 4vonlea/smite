...
class Member_m extends MY_Model
{
	...
	public $fillable = ['id', 'image', 'email', 'fullname', 'gender', 'phone', 'birthday', 'country', 'region', 'city', 'univ', 'address', 'username_account', 'status', 'verified_by_admin', 'verified_email', 'sponsor', 'alternatif_status','alternatif_status2'];
