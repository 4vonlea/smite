...
class Notification_m extends MY_Model{
    ...
    protected function wrapMessage($message){
        ...
        if($this->getType() == self::TYPE_GMAIL){
            $urlImageFooter = base_url('themes/img/email_header.jpg');// base_url('themes/img/email_footer.jpg');//file_get_contents(APPPATH."../themes/img/email_footer_64.txt");
            $urlImageHeader = base_url('themes/img/email_footer.jpg');//file_get_contents(APPPATH."../themes/img/email_header_64.txt");
