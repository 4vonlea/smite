...
//			if ($info['http_code'] != 201 && !in_array($result_array->status_code, array(200, 201, 202, 407))) {
	...
	public static function getSnapToken($params)
	{
		...
		$result = Midtrans::post(Midtrans::getSnapBaseUrl() . '/transactions', Midtrans::$serverKey, $params);
		return $result->token;
	}
	...
	{
		return Midtrans::get(Midtrans::getBaseUrl() . '/' . $id . '/status', Midtrans::$serverKey, false);
	}
